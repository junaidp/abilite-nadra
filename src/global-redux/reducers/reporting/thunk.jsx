...
export const getAllReporting = async (data, thunkAPI) => {
  try {
    ...
    let props = await axios.get(
      `${baseUrl}/reportingAndFollowUp/reporting/getAll/light?companyId=${data?.companyId}&pageNo=${data?.page}&noOfRecords=${data?.itemsPerPage}&currentYear=${data?.year}`,
      {
        headers: {
...
export const getSingleReportLite = async (data, thunkAPI) => {
  try {
    const { user } = thunkAPI.getState().auth;
    let props = await axios.get(`${baseUrl}/reportingAndFollowUp/getLite${data}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${user[0]?.token}`,
      },
...
export const getInitialSingleReportLite = async (data, thunkAPI) => {
  try {
    const { user } = thunkAPI.getState().auth;
    let props = await axios.get(`${baseUrl}/reportingAndFollowUp/getLite${data}`, {
      headers: {
...
export const getSingleObservation = async (data, thunkAPI) => {
  try {
    const { user } = thunkAPI.getState().auth;
    let props = await axios.get(
...
export const getAllFollowUp = async (data, thunkAPI) => {
  try {
    const { user } = thunkAPI.getState().auth;
    let props = await axios.get(
      `${baseUrl}/reportingAndFollowUp/followup/getAll/light?companyId=${data?.companyId}&pageNo=${data?.page}&noOfRecords=${data?.itemsPerPage}&currentYear=${data?.year}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${user[0]?.token}`,
