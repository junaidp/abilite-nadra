...
const ReportFirstLayout = ({ editableSummarizedReport, handleChangeReportObject }) => {
    return (
        <div>
            <div className="row  ">
                ...
                <div className="row mb-3">
                    ...
                    <div className="row mb-3 f-13 mt-3">
                        <div className="col-lg-4 px-3 d-flex justify-content-between">
                            ...
                            <div className="">
                                {editableSummarizedReport?.resourceAllocation?.headOfInternalAudit
                        ...
                        <div className="col-lg-4 px-3 d-flex justify-content-between">
                            ...
                            <div className="">
                                {editableSummarizedReport?.resourceAllocation
                        ...
                        <div className="col-lg-4 px-3 d-flex justify-content-between">
                            ...
                            <div className="">
                                {editableSummarizedReport?.resourceAllocation?.proposedJobApprover
                    ...
                    <div className="row mb-3 mt-3 f-13">
                        <div className="col-lg-4 px-3 d-flex gap-4 flex-wrap w-100">
                            ...
                            {editableSummarizedReport?.resourceAllocation?.resourcesList &&
                                editableSummarizedReport?.resourceAllocation?.resourcesList
                                    .length ? (
