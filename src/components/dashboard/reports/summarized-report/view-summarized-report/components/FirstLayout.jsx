...
/**
 * Displays the basic details of a summarized report — job info, dates, risk approach, and assigned resources.
 * All fields are readonly, ensuring consistent view mode without altering styles or structure.
 */
            ...
            <div className="border px-3 py-2 rounded">
                <div className="row mb-3">
                    ...
                    <div className="col-lg-6">
                        ...
                        <input
                            ...
                            type="date"
                            name="reportDate"
                            value={formatDate(singleSummarizedReport?.reportDate)}
                            disabled
                            readOnly
                        />
                    </div>
                ...
                <div className="row mb-3">
                    <div className="col-lg-6">
                        ...
                        <input
                            ...
                            type="date"
                            disabled
                            value={formatDate(singleSummarizedReport?.plannedStartDate)}
                        />
                    </div>
                    <div className="col-lg-6">
                        ...
                        <input
                            ...
                            type="date"
                            disabled
                            value={formatDate(singleSummarizedReport?.plannedEndDate)}
                        />
                    </div>
                </div>
                ...
                <div className="row mb-3 mt-3 f-13">
                    <div className="col-lg-4 px-3 d-flex gap-4 flex-wrap w-100">
                        ...
                        {singleSummarizedReport?.resourceAllocation?.resourcesList?.length ? (
