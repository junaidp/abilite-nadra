...
const RaiseRequestInformationDialog = ({ setShowInformationRequestDialog }) => {
  return (
    <div className="px-4 py-4 information-request-dialog-main-wrap">
      <header className="section-header my-3   text-start d-flex align-items-center justify-content-between">
        <div className="mb-0 heading d-flex align-items-center">
          <h2 className="mx-2 m-2 heading">Raise Request Information</h2>
        </div>
      ...
      <div className="row mb-2">
        ...
        <div className="col-lg-8 align-self-end">
          <button
            ...
            onClick={() => setShowInformationRequestDialog(false)}
          >
            Send
          </button>
        </div>
...
export default RaiseRequestInformationDialog;
